...
*This demo README was prepared by Alina Shah to illustrate the structure and methodology of her contribution to the ProbeEng framework developed at the Cornell Long-Term AI Safety Lab (LAISR). It omits all restricted datasets, configurations, and internal analysis modules. Results shown are illustrative, not official lab outputs.*
